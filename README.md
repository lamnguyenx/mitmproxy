...
> **Summary**: mitmproxy is an interactive SSL/TLS-capable intercepting proxy with console interface for HTTP/1, HTTP/2, and WebSockets, including mitmdump and mitmweb variants.
